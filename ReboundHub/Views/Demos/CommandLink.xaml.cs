...
namespace ReboundHub.Views.Demos
{
    ...
    /// </summary>
    public sealed partial class CommandLink : Page
    {
        public CommandLink()
        {
        ...
        {
            // The URI to launch
            string uriToLaunch = @"https://github.com/Ivirius-Main/ReboundHub/blob/main/ReboundHub/Views/Demos/CommandLink.xaml";
